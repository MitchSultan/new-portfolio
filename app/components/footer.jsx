  ...
  return (
    <footer className="bg-surface transition-colors">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        >
          <strong className="text-xl text-primary sm:text-xl"> Boost your Business today! </strong>
      ...
      <div className="mt-16 sm:flex sm:items-center sm:justify-between border-t border-gray-200 pt-8">
