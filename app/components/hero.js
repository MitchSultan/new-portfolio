        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div className="hero-content sm:p-4">
                <h1 className="mb-5 text-3xl  font-bold !leading-[1.208] text-dark  sm:text-[32px] lg:text-[60px] xl:text-8xl">
            Full-stack web Developer, Freelancer<br></br> Wannabe Pilot
                </h1>
                <p className="mb-8 max-w-[480px] text-base text-body-color dark:text-dark-6">
                  I'm Mitch Sultan, a Full-stack Website Developer. I currently work as a freelancer in Kenya trying to empower local busieness explore a space on their own terms.
                </p>
            ...
            <div className=" sm:hidden lg:pl-20">
              <div className="lg:ml-auto lg:text-right">
                <div className="relative z-10 w-36 h-36 rounded-full inline-block pt-11 lg:pt-0">
                  <img
                    src="/images/hero.png"
                    alt="hero"
                    className="w-24 h-24 rounded-full sm:hidden lg:ml-auto"
                  />
